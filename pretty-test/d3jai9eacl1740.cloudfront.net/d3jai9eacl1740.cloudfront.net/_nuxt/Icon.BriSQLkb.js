...
import I from "./Icon.DDQP7vzt.js";
import {
    _ as $
        ...
        const n = k(),
            ...
            y = p(() => {
                ...
                const s = l(t),
                    h = l(o),
                    g = l(e);
                return w((s == null ? void 0 : s.strategy) || ((d = i.ui) == null ? void 0 : d.strategy), g ? {
                    wrapper: g
                } : {}, s || {}, a ? B(i.ui, r, {}) : {}, h || {})
            }),
            b = p(() => A(n, ["class"]));
...
const q = v({
    ...
    setup(r) {
        ...
        return {
            dynamic: p(() => {
                var e, a;
                return r.dynamic || ((a = (e = t.ui) == null ? void 0 : e.icons) == null ? void 0 : a.dynamic)
            })
        }
    }
});

function N(r, t, o, e, a, n) {
    const i = I;
    return r.dynamic ? (c(), _(i, {
        key: 0,
        name: r.name
    }, null, 8, ["name"])) : (c(), C("span", {
        key: 1,
        class: z(r.name)
    }, null, 2))
}
